#!/usr/bin/env bash
# dp-offline-upgrade-jammy-to-noble.sh - single-file offline Jammy→Noble upgrade
# Generated by: scripts/ubuntu-offline-mirror.sh build-client-jammy-to-noble
# Target host: Ubuntu 22.04 Jammy source (Bash 5.1 / systemd 249 / apt 2.4); upgrades to 24.04 Noble
#
...
# DP bringup / product validation (Phase 2).
set -euo pipefail

SCRIPT_VERSION="1.0.0-jammy-to-noble"
...
PIN_MIRROR_BASE='http://127.0.0.1'
...
PIN_KEY_FINGERPRINT='76A63B3F9CB8B09955C28943C77DC1FF23BF31B5'
PIN_KEY_SHA256='7c8df00cce7bccb0aed21ca3eec214034a7cff8051fee9e72ebb1673e81ecb7e'
PIN_MANIFEST_KEY_FINGERPRINT='76A63B3F9CB8B09955C28943C77DC1FF23BF31B5'
PIN_MANIFEST_KEY_SHA256='7c8df00cce7bccb0aed21ca3eec214034a7cff8051fee9e72ebb1673e81ecb7e'
PIN_META_SHA256='d80379c3ca875306b6d91994bcc59c751cb0f08df5f9289ba7fe0e1cb12ca705'
PIN_UPGRADER_TAR_SHA256='447f54cbdfb9f57d32ddb02fcf0a0abb0184059cc0f680e806d23379878fe396'
...

nJ1bfG5Mnxl9DcNYvlFY4EAazSzxZgzHHJbDsUU2E7RUSu5Q'
PIN_MANIFEST_KEY_B64='
...
/EByoqu+kzsg4hZN6pm19E2aUPwr92oUxbPV80eNxFzQotYAzOu41lQIX5VKYCCCisSN7uGF0dny
nJ1bfG5Mnxl9DcNYvlFY4EAazSzxZgzHHJbDsUU2E7RUSu5Q'
PIN_META_B64=''
PIN_MANIFEST_B64='
...
YTAyNjRiMDIwMmIxY2E3MmY0MjAzYTM1YjJlYWQ2NDk4OGIzIgogIH0KfQo='
...
'
...
MIN_DP_VERSION="6.2.0"       # Phase 1 hard gate when version is authoritatively known
...
# Offline LXD transition guard (Jammy→Noble: unused deb removable; snap/transitional blocked).
LXD_PREFLIGHT_CLASS=""
...
# Core packages inspected for mixed Jammy/Noble state and cross-release candidates.
...
# Multi-hop ownership (Jammy→Noble must not inherit Focal→Jammy runtime flags).
...
marker_owned_by_current_hop() {
  ...
  [[ -n "$hop" ]] || return 1
  [[ "$hop" == "${PIN_HOP:-jammy-to-noble}" ]] || return 1
...
load_release_upgrade_started_flag_for_current_hop() {
  # Never promote previous-hop (focal-to-jammy) markers into current-hop globals.
  ...
  _load_flag_if_current() {
    ...
    if [[ -n "$current_hop" && "$current_hop" == "${PIN_HOP:-jammy-to-noble}" ]] \
      && [[ ! -f "${f}.meta" ]]; then
      # Legacy current-hop marker without meta - treat as current only in mid-hop states.
      case "$st" in
        CONFIGURING|PREPARING_JAMMY|UPGRADING_JAMMY_TO_NOBLE|REBOOT_PENDING|REBOOTING|POST_BOOT_VERIFY|FAILED_AFTER_PACKAGE_TRANSITION|FAILED_POST_TRANSACTION)
          printf -v "$var" '%s' "true"
          ;;
      esac
    fi
...
source_suite_still_jammy() {
  local sl
  sl="$(hostpath /etc/apt/sources.list)"
  [[ -f "$sl" ]] || return 1
  if grep -qE '[[:space:]]jammy(-|$|[[:space:]])' "$sl" 2>/dev/null; then
    # Fail if sources already primarily on noble without jammy.
    if grep -qE '[[:space:]]noble(-|$|[[:space:]])' "$sl" 2>/dev/null \
      && ! grep -qE '[[:space:]]jammy(-|$|[[:space:]])' "$sl" 2>/dev/null; then
      return 1
    fi
    return 0
  fi
  # Our stellar offline list uses jammy suites during Phase 1 prep.
  if grep -qE 'stellar-offline|jammy' "$sl" 2>/dev/null; then
    return 0
  fi
  return 1
}
...
persist_source_product_env() {
  # Compatibility wrapper — authoritative logic lives in shared source-product helper.
  local dest raw origin os_id code run_id
  ...
  if [[ -r /etc/os-release ]]; then
    os_id="$(grep -E '^VERSION_ID=' /etc/os-release | head -1 | cut -d= -f2- | tr -d '"')"
    code="$(grep -E '^VERSION_CODENAME=' /etc/os-release | head -1 | cut -d= -f2- | tr -d '"')"
  fi
  run_id="${RUN_ID:-$(utc_now)}"
  if ! declare -F spv_persist_source_product_env >/dev/null 2>&1; then
    log WARN "SOURCE_PRODUCT_ENV=HELPER_MISSING"
    return 0
  fi
  if [[ "${DP_VERSION_DETECT_STATUS:-}" != "ok" || "${DP_VERSION_CONSISTENCY:-}" != "PASS" ]]; then
    log INFO "SOURCE_PRODUCT_ENV=SKIPPED_INCOMPLETE_DETECT"
    return 0
  fi
  if spv_persist_source_product_env "$dest" "$raw" "$origin" "$os_id" "$code" "$run_id"; then
    log INFO "SOURCE_PRODUCT_ENV=${SPV_SOURCE_VERSION_CAPTURE_STATUS} version=${SPV_SOURCE_DP_VERSION}"
  else
...
log_product_state_phase1() {
  ...
  # Known unsupported / at-target DP versions must never enter destructive OS mutation.
  # UNDETERMINED source remains non-hard-gated (no invented product policy).
  if [[ "${DP_VERSION_DETECT_STATUS:-}" == "ok" && "${DP_VERSION_CONSISTENCY:-}" == "PASS"       && -n "${DP_VERSION:-}" && "${DP_VERSION}" != "UNDETERMINED" ]]; then
    ...
    log INFO "DP_VERSION_GATE=PASS_SUPPORTED source=${DP_VERSION} min=${MIN_DP_VERSION} target_excl=6.6.0"
  elif [[ -n "${DP_VERSION:-}" && "${DP_VERSION}" != "UNDETERMINED"       && "${DP_VERSION_DETECT_STATUS:-}" == "ok"       && "${DP_VERSION_CONSISTENCY:-}" != "PASS" ]]; then
    log ERROR "DP_VERSION_GATE=FAIL_INCONSISTENT version=${DP_VERSION} consistency=${DP_VERSION_CONSISTENCY:-}"
    die "$EC_DP" "FAIL_DP_VERSION_INCONSISTENT version=${DP_VERSION}"
  else
...
verify_mirror_trust_chain() {
  ...
  local up_tar="${MIRROR_BASE}/offline/release-upgraders/noble/noble.tar.gz"
  ...
  http_fetch "$up_tar" "${tmp}/noble.tar.gz"
  http_fetch "$up_gpg" "${tmp}/noble.tar.gz.gpg"
  [[ "$(sha256_file "${tmp}/noble.tar.gz")" == "$PIN_UPGRADER_TAR_SHA256" ]] \
    || die "$EC_TRUST" "upgrader tar SHA256 mismatch"
  [[ "$(sha256_file "${tmp}/noble.tar.gz.gpg")" == "$PIN_UPGRADER_GPG_SHA256" ]] \
...
check_os_baseline() {
  ...
  # AWS next-hop source readiness + fail-closed baseline persistence.
  # Must run before any destructive package/LXD/release mutation.
  if declare -F validate_aws_source_kernel_preflight >/dev/null 2>&1; then
    validate_aws_source_kernel_preflight "${PIN_SOURCE_VERSION}" || {
      log ERROR "AWS source kernel preflight failed; refusing destructive upgrade stages"
      return 1
    }
  fi
  if declare -F persist_source_kernel_generic_baseline >/dev/null 2>&1; then
    persist_source_kernel_generic_baseline || {
      log ERROR "GENERIC_SOURCE_KERNEL_BASELINE=FAIL"
      die "$EC_PREFLIGHT" "failed to persist generic source kernel baseline"
    }
  fi
  if declare -F persist_source_kernel_aws_baseline >/dev/null 2>&1; then
    persist_source_kernel_aws_baseline || {
      log ERROR "AWS source kernel baseline persistence failed; refusing hop"
      return 1
    }
  fi
...
assert_aella_login_shell_preflight() {
  # Non-mutating preflight: aella must exist with a recognized shell.
  # Mutation to /bin/bash happens only in change_login_shells after confirmation+backup.
  local shell="" passwd_file line
  passwd_file="$(hostpath /etc/passwd)"
  if [[ -n "$TEST_ROOT" ]]; then
    line="$(grep -E '^aella:' "$passwd_file" 2>/dev/null || true)"
    if [[ -z "$line" ]]; then
      log ERROR "AELLA_LOGIN_SHELL_PREFLIGHT=FAIL"
      log ERROR "FAIL_AELLA_ACCOUNT_MISSING"
      die "$EC_BASELINE" "FAIL_AELLA_ACCOUNT_MISSING"
    fi
    shell="$(printf '%s' "$line" | cut -d: -f7)"
  else
    if ! getent passwd aella >/dev/null 2>&1; then
      log ERROR "AELLA_LOGIN_SHELL_PREFLIGHT=FAIL"
      log ERROR "FAIL_AELLA_ACCOUNT_MISSING"
      die "$EC_BASELINE" "FAIL_AELLA_ACCOUNT_MISSING"
    fi
  ...
  if [[ -z "$shell" ]]; then
    log ERROR "AELLA_LOGIN_SHELL_PREFLIGHT=FAIL shell=empty"
    log ERROR "FAIL_AELLA_SHELL_UNSUPPORTED"
    die "$EC_BASELINE" "FAIL_AELLA_SHELL_UNSUPPORTED"
  fi
  # /bin/bash must be available for the later commit-phase mutation/normalization.
  if [[ -n "$TEST_ROOT" ]]; then
    if [[ ! -x "$(hostpath /bin/bash)" && ! -x /bin/bash ]]; then
      log ERROR "AELLA_LOGIN_SHELL_PREFLIGHT=FAIL"
      log ERROR "FAIL_LOGIN_SHELL_BASH_MISSING"
      die "$EC_BASELINE" "FAIL_LOGIN_SHELL_BASH_MISSING"
    fi
  else
  ...
  case "$shell" in
    /bin/bash)
      log INFO "AELLA_LOGIN_SHELL_PREFLIGHT=PASS"
      log INFO "AELLA_LOGIN_SHELL_SOURCE=/bin/bash"
      log INFO "AELLA_LOGIN_SHELL_CLASS=ALREADY_READY"
      log INFO "AELLA_LOGIN_SHELL_CHANGE_REQUIRED=NO"
      log INFO "SHELL_MUTATION_DURING_PREFLIGHT=NO"
      return 0
      ;;
    /usr/bin/bash)
      log INFO "AELLA_LOGIN_SHELL_PREFLIGHT=PASS"
      log INFO "AELLA_LOGIN_SHELL_SOURCE=/usr/bin/bash"
      log INFO "AELLA_LOGIN_SHELL_CLASS=COMPATIBLE_BASH"
      log INFO "AELLA_LOGIN_SHELL_CHANGE_REQUIRED=NO"
      log INFO "SHELL_MUTATION_DURING_PREFLIGHT=NO"
      return 0
      ;;
    /usr/bin/aella_cli)
      log INFO "AELLA_LOGIN_SHELL_PREFLIGHT=PASS"
      log INFO "AELLA_LOGIN_SHELL_SOURCE=/usr/bin/aella_cli"
      log INFO "AELLA_LOGIN_SHELL_CLASS=EXPECTED_STELLAR_DP_SHELL"
      log INFO "AELLA_LOGIN_SHELL_CHANGE_REQUIRED=YES"
      log INFO "SHELL_MUTATION_DURING_PREFLIGHT=NO"
      return 0
      ;;
  esac
  log ERROR "AELLA_LOGIN_SHELL_PREFLIGHT=FAIL shell=${shell}"
  log ERROR "FAIL_AELLA_SHELL_UNSUPPORTED"
  log ERROR "Recognized aella shells: /usr/bin/aella_cli /bin/bash /usr/bin/bash"
  log ERROR "Unsupported shells are fail-closed; do not chsh manually unless recovering a broken host"
  die "$EC_BASELINE" "FAIL_AELLA_SHELL_UNSUPPORTED"
}

# Backward-compatible alias (older docs/tests may still reference the hard-gate name).
...
detect_partial_release_transition() {
  # Fail-closed when os-release is still Jammy but core packages look Noble,
  ...
  # Previous-hop (focal-to-jammy) runtime markers must NOT trigger this check.
  ...
  if declare -F classify_mutation_evidence_ownership >/dev/null 2>&1; then
    ...
    case "${MUTATION_EVIDENCE_CLASS:-NO_MUTATION}" in
      PREVIOUS_HOP_MUTATION)
        ...
        # Under COMPLETED_JAMMY, handle_existing_state owns handoff; do not treat as partial.
        PARTIAL_RELEASE_TRANSITION="NO"
        return 0
        ;;
  ...
  if [[ "$ver" == "$PIN_SOURCE_VERSION" || "$codename" == "$PIN_SOURCE_CODENAME" ]]; then
    ...
    for pkg in base-files libc6 apt dpkg systemd systemd-sysv; do
      ivers="$(pkg_installed_version "$pkg")"
      if is_noble_version_for_pkg "$pkg" "$ivers"; then
  ...
  if has_upgrade_transaction_evidence; then
    if [[ "$st" == "FAILED" || "$st" == "PREPARING_JAMMY" || "$st" == "UPGRADING_JAMMY_TO_NOBLE" ]]; then
...
# --- Python2 inventory / transition evidence (Jammy→Noble Phase 1) ------------
# Policy:
...
run_os_preflight() {
  ...
  if [[ "$version_id" != "$PIN_SOURCE_VERSION" || "$codename" != "$PIN_SOURCE_CODENAME" ]]; then
    # Allow completed noble re-entry handled by caller
  ...
  # do-release-upgrade frontend support check (jammy)
...
print_final_hop_notice() {
  # Jammy -> Noble only. Informational; does not add a second confirmation prompt.
  cat <<'EOF'

============================================================
 FINAL OS HOP: Ubuntu 22.04 Jammy -> Ubuntu 24.04 Noble
============================================================

[IMPORTANT] At the Ubuntu 22.04 intermediate stage, DP services are
            interrupted and DP product features are unavailable.

[IMPORTANT] aella_cli is unavailable at this stage. Phase 1 does NOT
            perform DP product state validation.

[CONFIRMED CAUSE]
 Existing kubelet Docker API client 1.40 is incompatible with the
...
[PROHIBITED]
 Do NOT modify, reinstall, upgrade, downgrade, or manually restart
 kubelet, Docker, containerd, or Kubernetes during Phase 1.

[NEXT STEPS]
 After Ubuntu 24.04 OS validation and a powered-off snapshot,
 Phase 2 bringup_py3 --skip-download rebuilds the product runtime.

[AUTO-EXECUTION CAUTION]
 After systemd handoff, do NOT re-run this upgrade client if SSH drops.
 While an automatic reboot is pending, do NOT reboot manually.

============================================================
EOF
  log INFO "FINAL_HOP_NOTICE=DISPLAYED"
  log INFO "JAMMY_DP_RUNTIME_STATE=UNAVAILABLE_EXPECTED"
  log INFO "JAMMY_PRODUCT_VALIDATION=NOT_RUN_PHASE1"
  log INFO "JAMMY_AELLA_CLI=UNAVAILABLE"
  log INFO "JAMMY_RUNTIME_REPAIR=PROHIBITED_PHASE1"
  log INFO "PHASE2_RUNTIME_REBUILD=REQUIRED_ON_NOBLE"
}
...
- Phase 2 (DP bringup / product validation) will NOT start automatically
EOF
  if [[ -n "$PLANNED_CRITICAL_OS_HOLDS" ]]; then
    cat <<EOF
...
disable_third_party_sources() {
  ...
  for f in "$lists"/*; do
    ...
    if [[ "$base" == "stellar-offline-jammy-to-noble.list" ]]; then
      continue
    fi
    mv -f "$f" "$dest/$base"
...
EOF
  ...
  # needrestart is present on Jammy+; keep for Noble hop compatibility.
...
restore_login_shells_from_backup() {
  # Commit-path restore: reverse change_login_shells using shell-changes.tsv.
  # Safe only before package/release transition (same boundary as APT/hold restore).
  local stamp="$1"
  local reason="${2:-pre_upgrade_failure}"
  local rec user shell passwd_file
  rec="$(hostpath "${BACKUP_ROOT}/${stamp}/passwd/shell-changes.tsv")"
  if [[ ! -f "$rec" ]]; then
    log WARN "LOGIN_SHELL_RESTORE=SKIPPED reason=no_shell_changes stamp=${stamp}"
    return 0
  fi
  log INFO "LOGIN_SHELL_RESTORE_BEGIN reason=${reason} backup=${rec}"
  passwd_file="$(hostpath /etc/passwd)"
...
apply_distupgrade_mirror_override() {
  ...
  # IMPORTANT: DistUpgradeConfigParser (Jammy/Python 3.5) reads these with the
...
# stellar offline DistUpgrade ValidMirrors overlay (Jammy-to-Noble)
...
# Generated by stellar offline Jammy-to-Noble client.
# DistUpgradeConfig reads release-upgrades.d/*.cfg after DistUpgrade.cfg.jammy.
[Sources]
...
def _deb822_is_disabled(stanza):
    en = stanza.get('Enabled', ['yes'])
    if not en:
        return False
    return str(en[0]).strip().lower() in ('no', 'false', '0')

def _deb822_split_values(vals):
    out = []
    for v in vals or []:
        out.extend(str(v).split())
    return out

def parse_deb822_stanzas(text):
    """Parse deb822 apt sources into entry dicts (deb types only)."""
    entries = []
    errors = []
    official = 0
    stanzas = []
    ...
    for raw_line in text.splitlines():
        ...
        if raw_line.lstrip().startswith('#'):
            continue
        if raw_line[:1] in (' ', '\t') and cur_key:
            cont = raw_line.strip()
            if cont.startswith('#'):
                continue
            cur.setdefault(cur_key, []).append(cont)
            continue
        if ':' not in raw_line:
            errors.append('MALFORMED_DEB822_LINE')
            continue
        key, val = raw_line.split(':', 1)
        key = key.strip()
        val = val.strip()
        if not key or any(ch.isspace() for ch in key):
            errors.append('MALFORMED_DEB822_KEY')
            continue
        cur_key = key
        cur.setdefault(key, [])
        if val:
    ...
    if cur:
        stanzas.append(cur)
    for st in stanzas:
        if _deb822_is_disabled(st):
            continue
        types = [t.lower() for t in _deb822_split_values(st.get('Types'))]
        if not types:
            errors.append('MALFORMED_DEB822_TYPES')
            continue
        if 'deb' not in types:
            continue
        uris = _deb822_split_values(st.get('URIs') or st.get('URI'))
        suites = _deb822_split_values(st.get('Suites') or st.get('Suite'))
        comps = _deb822_split_values(st.get('Components') or st.get('Component'))
        if not uris or not suites:
            errors.append('MALFORMED_DEB822_STANZA')
            continue
        for uri in uris:
            if OFFICIAL_RE.search(uri):
                official += 1
        for opt_key in ('Signed-By', 'signed-by', 'Trusted', 'trusted'):
            if opt_key in st:
                val0 = ' '.join(st.get(opt_key) or []).strip().lower()
                if opt_key.lower() == 'trusted' and val0 in ('yes', 'true', '1'):
                    entries.append({'forbidden': 'trusted=yes', 'raw': 'Trusted: ' + val0})
                elif 'signed' in opt_key.lower() and val0:
                    entries.append({'forbidden': 'signed-by', 'raw': 'Signed-By: ' + val0})
        arches = _deb822_split_values(st.get('Architectures') or st.get('Architectures-Add') or [])
        for uri in uris:
            uri_n = uri.rstrip('/')
            for suite in suites:
                entries.append({
                    ...
                    'archs': arches,
                    'forbidden': '',
                    'raw': 'deb822:%s %s' % (uri_n, suite),
                    'format': 'deb822',
                })
    return entries, errors, official
...
def main():
    ...
    to_series = os.environ.get('STELLAR_TARGET_CODENAME', 'noble')
    from_series = os.environ.get('STELLAR_SOURCE_CODENAME', 'jammy')
        ...
        for path in source_files:
            ...
            if capture_dir:
                try:
                    ...
                    pass
            is_deb822 = path.endswith('.sources')
            file_entries = []
            if is_deb822:
                file_entries, deb822_errors, deb822_official = parse_deb822_stanzas(text)
                official += deb822_official
                if deb822_errors:
                    emit('DISTUPGRADE_EFFECTIVE_SOURCE_CAPTURE', 'FAIL')
                    emit('DISTUPGRADE_EFFECTIVE_SOURCE_GATE_STATE', 'FAILED')
                    emit('DISTUPGRADE_EFFECTIVE_SOURCE_GATE_ACTION', 'DENY')
                    emit('DISTUPGRADE_EFFECTIVE_SOURCE_GATE_REASON',
                         'MALFORMED_DEB822')
                    emit('DISTUPGRADE_EFFECTIVE_SOURCE_GATE_RESULT', 'FAIL')
                    emit('error', 'FAIL_DISTUPGRADE_EFFECTIVE_SOURCE_MALFORMED_DEB822')
                    emit('detail', '%s: %s' % (path, ','.join(deb822_errors)))
                    rc = 12
    ...
    # Source + target suites simultaneously → fail-closed (no mixed transition window).
    if has_src and has_tgt:
        emit('DISTUPGRADE_EFFECTIVE_SOURCE_GATE_STATE', 'ENFORCING_TARGET_SOURCES')
        emit('DISTUPGRADE_EFFECTIVE_SOURCE_CAPTURE', 'FAIL')
        emit('DISTUPGRADE_EFFECTIVE_SOURCE_GATE_ACTION', 'DENY')
        emit('DISTUPGRADE_EFFECTIVE_SOURCE_GATE_REASON', 'MIXED_SOURCE_TARGET_SUITES')
        emit('DISTUPGRADE_EFFECTIVE_SOURCE_GATE_RESULT', 'FAIL')
        emit('error', 'FAIL_DISTUPGRADE_EFFECTIVE_SOURCE_MIXED_SUITES')
        rc = 8
        inv_dir = next_invocation_dir(evid_root)
        snapshot_sources(inv_dir, source_files, out)
        append_log(log_path, [
    ...
    # Empty effective source set while armed → fail-closed.
    if not enabled:
        emit('DISTUPGRADE_EFFECTIVE_SOURCE_GATE_STATE', 'ENFORCING_TARGET_SOURCES')
        emit('DISTUPGRADE_EFFECTIVE_SOURCE_CAPTURE', 'FAIL')
        emit('DISTUPGRADE_EFFECTIVE_SOURCE_GATE_ACTION', 'DENY')
        emit('DISTUPGRADE_EFFECTIVE_SOURCE_GATE_REASON', 'EMPTY_EFFECTIVE_SOURCE_SET')
        emit('DISTUPGRADE_EFFECTIVE_SOURCE_GATE_RESULT', 'FAIL')
        emit('error', 'FAIL_DISTUPGRADE_EFFECTIVE_SOURCE_EMPTY')
        rc = 9
        inv_dir = next_invocation_dir(evid_root)
        snapshot_sources(inv_dir, source_files, out)
        append_log(log_path, [
...
#!/bin/bash
# stellar effective-source gate wrapper (Bash 4.4+ / Jammy)
GATE_BIN="${bin_path}"
...
# --- ASCII-only legacy config helpers (Jammy Python 3.6 / locale-safe) ---
...
render_update_manager_meta_release() {
  ...
  # hop_label must be ASCII (e.g. jammy-to-noble); never use UTF-8 arrows.
  cat >"$dest" <<EOF
...
change_login_shells() {
  ...
  _login_shell_set_to() {
    local u="$1" target="$2"
    if [[ -n "$TEST_ROOT" ]]; then
      awk -F: -v u="$u" -v s="$target" 'BEGIN{OFS=":"} $1==u {$7=s} {print}' \
        "$passwd_file" >"${passwd_file}.new"
      mv -f "${passwd_file}.new" "$passwd_file"
      return 0
    fi
    if command -v chsh >/dev/null 2>&1; then
      chsh -s "$target" "$u" && return 0
    fi
  ...
  _login_shell_rollback_partial() {
    local reason="${1:-partial_shell_change_failure}" u orig cur
    log WARN "LOGIN_SHELL_TRANSACTION_ROLLBACK=BEGIN reason=${reason}"
    if [[ -s "$rec" ]]; then
      while IFS=$'\t' read -r u orig; do
        [[ -n "$u" && -n "$orig" ]] || continue
        if [[ -n "$TEST_ROOT" ]]; then
          cur="$(grep -E "^${u}:" "$passwd_file" 2>/dev/null | cut -d: -f7 || true)"
        else
          cur="$(getent passwd "$u" 2>/dev/null | cut -d: -f7 || true)"
        fi
        if [[ "$cur" != "$orig" ]]; then
          if _login_shell_set_to "$u" "$orig"; then
            log INFO "LOGIN_SHELL_ROLLBACK_${u^^}=PASS restored=${orig}"
          else
            log ERROR "LOGIN_SHELL_ROLLBACK_${u^^}=FAIL wanted=${orig}"
          fi
        fi
      done <"$rec"
    fi
    log WARN "LOGIN_SHELL_TRANSACTION_ROLLBACK=DONE reason=${reason}"
  }
  ...
  for user in root aella; do
    if [[ -n "$TEST_ROOT" ]]; then
      ...
      printf '%s\t%s\n' "$user" "$shell" >>"$rec"
      if [[ "$shell" != "/bin/bash" ]]; then
        if [[ -n "${DP_OFFLINE_FAKE_SHELL_CHANGE_FAIL_USER:-}" \
            && "${DP_OFFLINE_FAKE_SHELL_CHANGE_FAIL_USER}" == "$user" ]]; then
          log ERROR "LOGIN_SHELL_AUTOMATION=FAIL"
          _login_shell_rollback_partial "injected_shell_change_fail_user=${user}"
          die "$EC_INTERNAL" "FAIL_LOGIN_SHELL_CHANGE_${user}"
        fi
        if ! _login_shell_set_to "$user" "/bin/bash"; then
          log ERROR "LOGIN_SHELL_AUTOMATION=FAIL"
          _login_shell_rollback_partial "shell_set_failed_${user}"
          die "$EC_INTERNAL" "FAIL_LOGIN_SHELL_CHANGE_${user}"
        fi
...
EFFECTIVE_SOURCE_GATE_EVIDENCE_ROOT="${STATE_ROOT}/evidence/effective-source-gate"
LEGACY_APT_KEYRING_PATH="$(_hp /etc/apt/trusted.gpg.d/stellar-offline-jammy-to-noble.gpg)"
UNIT_NAME="stellar-offline-os-upgrade.service"
POSTBOOT_UNIT_NAME="stellar-offline-os-upgrade-postboot.service"
COMMIT_BACKUP_PATH=""
COMMIT_STAMP=""
...
detect_package_transition_evidence() {
  ...
  if [[ -f "$status" ]]; then
    ...
    if printf '%s\n' "$status_tail" | awk '
      ...
      /^Version:/ {
        ver=$2
        if (st ~ /half-installed|unpacked/ && ver ~ /^(2\.37|2\.4\.|12ubuntu|249\.)/) exit 0
      }
      END { exit 1 }
    '; then
      PACKAGE_TRANSITION_DETECTION_SOURCE="package_state"
      PACKAGE_TRANSITION_DETECTION_EVIDENCE="jammy_half_installed_or_unpacked"
      return 0
    fi
  fi
...
classify_ntp_userdel_warning() {
  ...
  # Blocking is decided by the caller from apt/dpkg exit + package health - not this string alone.
  local found=0
  local f
  for f in \
    "$(hostpath /var/log/dist-upgrade/main.log 2>/dev/null || true)" \
    "$(hostpath /var/log/dist-upgrade/apt-term.log 2>/dev/null || true)" \
    "$(hostpath /var/log/dist-upgrade/apt.log 2>/dev/null || true)" \
    "$(hostpath /var/log/dpkg.log 2>/dev/null || true)" \
    "$(hostpath "$LOG_FILE" 2>/dev/null || true)"
  do
    [[ -n "$f" && -f "$f" ]] || continue
    if grep -qE "userdel: user ntp is currently used by process|fatal: '/usr/sbin/userdel ntp' returned error code 8" "$f" 2>/dev/null; then
      found=1
      break
    fi
  done
  if [[ "$found" -eq 1 ]]; then
    ...
    log WARN "NTP_USERDEL_WARNING_DETECTED=YES"
    log WARN "NTP_USERDEL_WARNING_NOTE=old_ntp_purge_userdel_error_8_observed"
  else
    NTP_USERDEL_WARNING_DETECTED="NO"
    log INFO "NTP_USERDEL_WARNING_DETECTED=NO"
  fi
}

emit_ntp_userdel_summary() {
  # transaction_ok: 1 when apt/dpkg transaction and package health passed.
  local transaction_ok="${1:-0}"
  if [[ "${NTP_USERDEL_WARNING_DETECTED:-NO}" != "YES" ]]; then
    log INFO "NTP_USERDEL_WARNING_DETECTED=NO"
    return 0
  fi
  if [[ "$transaction_ok" -eq 1 ]]; then
    log WARN "NTP_USERDEL_WARNING_BLOCKING=NO"
    log WARN "NTP_USERDEL_WARNING_CLASS=NON_BLOCKING"
  else
    log ERROR "NTP_USERDEL_WARNING_BLOCKING=YES"
    log ERROR "NTP_USERDEL_WARNING_CLASS=BLOCKING_WITH_PACKAGE_FAILURE"
  fi
}
...
classify_dro_failure() {
  ...
  # Still on Jammy with no package mutation -> pre-transition failure (rollback eligible).
  RELEASE_UPGRADE_PACKAGE_TRANSITION_STARTED="false"
  persist_flags
...
main() {
  ...
  export DEBIAN_PRIORITY=critical
  export UCF_FORCE_CONFFOLD=1
  # needrestart is present on Jammy+; ignored when the package is absent.
  export NEEDRESTART_MODE=a
  write_runner_pid
  log_runner_start
  ...
  if [[ "$rc" -ne 0 ]]; then
    classify_dro_failure
    classify_ntp_userdel_warning || true
    emit_ntp_userdel_summary 0 || true
  ...
  classify_ntp_userdel_warning || true
  emit_ntp_userdel_summary 1 || true
  local ver
  ver="$(grep -E '^VERSION_ID=' "$(_hp /etc/os-release)" | cut -d= -f2 | tr -d '"')"
  if [[ "$ver" != "24.04" && ! -f /var/run/reboot-required && ! -d /var/log/dist-upgrade ]]; then
  ...
  if declare -F validate_aws_target_kernel_pre_reboot >/dev/null 2>&1; then
    if ! validate_aws_target_kernel_pre_reboot "24.04"; then
      log ERROR "PRE_REBOOT_AWS_TARGET_GATE=FAIL; refusing automatic reboot"
      write_state FAILED
      fail_stage 1 "AWS target kernel not ready before reboot"
    fi
  fi
...
[Unit]
Description=Stellar offline OS upgrade Jammy to Noble
...
[Unit]
Description=Stellar offline OS upgrade post-boot verification (Jammy)
After=network-online.target local-fs.target
Wants=network-online.target
...
state_is_upgrade_running() {
  local st="$1"
  case "$st" in
    # PREPARING_JAMMY alone is not proof of a live upgrade (may be stale after runner crash).
    UPGRADING_JAMMY_TO_NOBLE|POST_UPGRADE_VERIFY|REBOOT_PENDING|REBOOTING)
      return 0
      ;;
    *)
      return 1
...
state_is_in_progress_or_configuring() {
  local st="$1"
  case "$st" in
    CONFIGURING|PREPARING_JAMMY|UPGRADING_JAMMY_TO_NOBLE|REBOOT_PENDING|REBOOTING|POST_BOOT_VERIFY|POST_UPGRADE_VERIFY)
      return 0
      ;;
    *)
      return 1
...
state_is_active_progress() {
  case "${1:-}" in
    CONFIGURING|PREPARING_JAMMY|UPGRADING_JAMMY_TO_NOBLE|POST_UPGRADE_VERIFY)
      return 0
      ;;
    *)
      return 1
...
assert_state_classification_disjoint() {
  ...
  for st in REBOOT_PENDING REBOOTING POST_BOOT_VERIFY \
      UPGRADING_JAMMY_TO_NOBLE POST_UPGRADE_VERIFY CONFIGURING PREPARING_JAMMY \
      COMPLETED_NOBLE SUCCESS FAILED; do
...
commit_and_start() {
  ...
  # Noble's transitional package (api.snapcraft.io). Fail-closed on risk.
  ...
  if dp_offline_hermetic_fixtures_enabled && [[ -n "$TEST_ROOT" && "${DP_OFFLINE_FAKE_FAIL_AFTER_UNHOLD:-}" == "1" ]]; then
    ...
    restore_login_shells_from_backup "$stamp" "injected_pre_upgrade_failure" || true
  ...
  if [[ "$rc" -ne 0 ]]; then
    ...
    restore_login_shells_from_backup "$stamp" "pre_upgrade_failure" || true
    case "$rc" in
...
# Previous-hop (Focal→Jammy) terminal success state may remain on disk when the
# Jammy→Noble client starts. That is a normal multi-hop handoff, not corruption.
...
is_jammy_to_noble_client() {
  # This template is always jammy→noble; pin identity must still match.
  [[ "${PIN_HOP:-}" == "jammy-to-noble" ]] \
    && [[ "${PIN_SOURCE_VERSION:-}" == "22.04" ]] \
    && [[ "${PIN_SOURCE_CODENAME:-}" == "jammy" ]] \
    && [[ "${PIN_TARGET_VERSION:-}" == "24.04" ]] \
...
classify_mutation_evidence_ownership() {
  ...
  if [[ -n "$marker_hop" ]]; then
    if [[ "$marker_hop" == "jammy-to-noble" ]]; then
  ...
  if [[ "$st" == "$PREVIOUS_HOP_TERMINAL_STATE" ]]; then
    ...
    if [[ "$pins_hop" == "$PREVIOUS_HOP_PIN_NAME" || "$manifest_hop" == "$PREVIOUS_HOP_PIN_NAME" ]]; then
      if [[ "$ver" == "22.04" && "$code" == "jammy" ]]; then
        MUTATION_EVIDENCE_CLASS="PREVIOUS_HOP_MUTATION"
        PREVIOUS_HOP_RUNTIME_OWNER="$PREVIOUS_HOP_PIN_NAME"
        return 0
      fi
    fi
    if [[ "$pins_hop" == "jammy-to-noble" || "$manifest_hop" == "jammy-to-noble" || "$current_hop" == "jammy-to-noble" ]]; then
      MUTATION_EVIDENCE_CLASS="CURRENT_HOP_MUTATION"
      return 0
    fi
  ...
  case "$st" in
    CONFIGURING|PREPARING_JAMMY|UPGRADING_JAMMY_TO_NOBLE|REBOOT_PENDING|REBOOTING|POST_BOOT_VERIFY|FAILED_AFTER_PACKAGE_TRANSITION|FAILED_POST_TRANSACTION)
      if [[ "$current_hop" == "jammy-to-noble" || "$pins_hop" == "jammy-to-noble" ]]; then
        MUTATION_EVIDENCE_CLASS="CURRENT_HOP_MUTATION"
        return 0
      fi
      MUTATION_EVIDENCE_CLASS="AMBIGUOUS_MUTATION_EVIDENCE"
    ...
    PREFLIGHT|READY_FOR_CONFIRMATION|READY_FOR_RESUME)
      ...
      if [[ "$current_hop" == "jammy-to-noble" && "$has_transition" -eq 1 ]]; then
        MUTATION_EVIDENCE_CLASS="CURRENT_HOP_MUTATION"
        return 0
      fi
      MUTATION_EVIDENCE_CLASS="AMBIGUOUS_MUTATION_EVIDENCE"
...
current_hop_mutation_evidence_present() {
  # 0 = current Jammy→Noble mutation evidence
...
classify_effective_source_gate_bundle() {
  ...
  if [[ "$wrap_present" -eq 1 && "$env_present" -eq 1 && -n "$env_hop" && -n "$current_hop" \
    && "$env_hop" != "$current_hop" && "$env_hop" != "${PREVIOUS_HOP_PIN_NAME:-focal-to-jammy}" ]]; then
    SOURCE_GATE_CLASS="AMBIGUOUS_GATE_CONFIGURATION"
    log INFO "SOURCE_GATE_CLASS=${SOURCE_GATE_CLASS}"
  ...
  if [[ "$hook_present" -eq 1 && "$wrap_present" -eq 0 ]]; then
    if [[ "$env_present" -eq 1 && -n "$env_hop" && "$env_hop" == "${PIN_HOP:-jammy-to-noble}" ]]; then
  ...
  if [[ "$hook_present" -eq 0 && ( "$wrap_present" -eq 1 || "$bin_present" -eq 1 || "$env_present" -eq 1 ) ]]; then
    if [[ -n "$env_hop" && "$env_hop" == "${PREVIOUS_HOP_PIN_NAME:-focal-to-jammy}" ]] \
      || [[ -n "$marker_hop" && "$marker_hop" == "${PREVIOUS_HOP_PIN_NAME:-focal-to-jammy}" ]]; then
      SOURCE_GATE_CLASS="PREVIOUS_HOP_GATE_COMPLETE"
    elif [[ -n "$env_hop" && "$env_hop" == "${PIN_HOP:-jammy-to-noble}" ]]; then
      SOURCE_GATE_CLASS="CURRENT_HOP_GATE_INCOMPLETE"
    else
      SOURCE_GATE_CLASS="PREVIOUS_HOP_GATE_COMPLETE"
    fi
  ...
  if [[ "$hook_present" -eq 1 && "$wrap_present" -eq 1 && "$bin_present" -eq 1 && "$env_present" -eq 1 ]]; then
    ...
    if [[ -n "$env_hop" && "$env_hop" == "${PREVIOUS_HOP_PIN_NAME:-focal-to-jammy}" ]]; then
      SOURCE_GATE_CLASS="PREVIOUS_HOP_GATE_COMPLETE"
      log INFO "SOURCE_GATE_CLASS=${SOURCE_GATE_CLASS}"
      return 0
    fi
...
archive_effective_source_gate_bundle() {
  ...
  manifest="${sg_root}/manifest.txt"
  {
    ...
    printf 'previous_hop=%s\n' "${PREVIOUS_HOP_RUNTIME_OWNER:-${PREVIOUS_HOP_PIN_NAME:-focal-to-jammy}}"
...
retire_effective_source_gate_bundle() {
  ...
  log INFO "SOURCE_GATE_PREVIOUS_HOP=${PREVIOUS_HOP_RUNTIME_OWNER:-${PREVIOUS_HOP_PIN_NAME:-focal-to-jammy}}"
...
_source_gate_preflight_repair_safe() {
  ...
  if [[ "$st" == "PREFLIGHT" || "$st" == "READY_FOR_CONFIRMATION" ]]; then
    if [[ "$current_hop" == "${PIN_HOP:-jammy-to-noble}" ]]; then
  ...
  if [[ ! -e "$(hostpath "$(_source_gate_standard_wrap_path)")" ]]; then
    if [[ -z "$env_hop" || "$env_hop" == "${PREVIOUS_HOP_PIN_NAME:-focal-to-jammy}" ]]; then
...
find_resumable_handoff_archive() {
  # Latest incomplete handoff archive (no handoff-complete.ok) for COMPLETED_JAMMY.
  local root newest f
  root="$(hostpath "$BACKUP_ROOT")"
  [[ -d "$root" ]] || return 1
  newest=""
...
find_latest_previous_hop_quarantine_backup() {
  # Return newest corrupt-state-* backup whose state file is exactly COMPLETED_JAMMY.
...
validate_previous_hop_handoff() {
  # Fail-closed cross-check before accepting Focal→Jammy terminal state.
  ...
  log INFO "PREVIOUS_HOP_TARGET_OS=22.04"
  ...
  elif ! is_jammy_to_noble_client; then
...
accept_previous_hop_terminal_state() {
  ...
  # Resume incomplete handoff (archive exists, live still COMPLETED_JAMMY).
  ...
  {
    printf 'event=JAMMY_TO_NOBLE_HANDOFF_PENDING\n'
    printf 'PREVIOUS_HOP_STATE=%s\n' "$st"
    printf 'PREVIOUS_HOP_TARGET_OS=22.04\n'
    printf 'PREVIOUS_HOP_RUNTIME_OWNER=%s\n' "${PREVIOUS_HOP_RUNTIME_OWNER:-$PREVIOUS_HOP_PIN_NAME}"
    printf 'CURRENT_OS=%s\n' "$(read_os_field VERSION_ID)"
  ...
  # current-hop.env must not be treated as already-initialized for Jammy→Noble.
  ...
  {
    printf 'event=JAMMY_TO_NOBLE_HANDOFF_ACCEPTED\n'
    printf 'PREVIOUS_HOP_STATE=%s\n' "$st"
    printf 'PREVIOUS_HOP_TARGET_OS=22.04\n'
    printf 'PREVIOUS_HOP_RUNTIME_OWNER=%s\n' "${PREVIOUS_HOP_RUNTIME_OWNER:-$PREVIOUS_HOP_PIN_NAME}"
    printf 'CURRENT_OS=%s\n' "$(read_os_field VERSION_ID)"
  ...
  log INFO "JAMMY_TO_NOBLE_HANDOFF_ACCEPTED=YES"
  return 0
}

try_recover_previous_hop_state_from_quarantine() {
  # Case B: live state missing/blank, but a corrupt-state quarantine holds COMPLETED_JAMMY.
  ...
  if [[ -n "$pins_hop" && "$pins_hop" != "$PREVIOUS_HOP_PIN_NAME" && "$pins_hop" != "jammy-to-noble" ]]; then
  ...
  local mid
  for mid in CONFIGURING PREPARING_JAMMY UPGRADING_JAMMY_TO_NOBLE REBOOT_PENDING REBOOTING \
...
handle_existing_state() {
  ...
  if [[ "$ver" == "24.04" ]]; then
    if [[ "$st" == "COMPLETED_NOBLE" ]]; then
      log INFO "already COMPLETED_NOBLE - nothing to do"
      exit 0
    fi
    # Previous-hop terminal on Noble is a contradiction - fail closed.
    if [[ "$st" == "$PREVIOUS_HOP_TERMINAL_STATE" ]]; then
      log ERROR "HOP_HANDOFF_VALIDATION=FAIL"
  ...
  # Case B: blank/missing live state + quarantined COMPLETED_JAMMY evidence.
  if [[ -z "$st" ]]; then
  ...
  case "$st" in
    ...
    CONFIGURING|PREPARING_JAMMY)
      ...
      refuse_duplicate_upgrade
      ;;
    UPGRADING_JAMMY_TO_NOBLE|REBOOT_PENDING|REBOOTING|POST_BOOT_VERIFY|POST_UPGRADE_VERIFY)
      refuse_duplicate_upgrade
      ;;
    ...
    COMPLETED_JAMMY)
      ...
      ;;
    COMPLETED_NOBLE)
      # Target-hop terminal on non-Noble OS is a contradiction (Noble handled above).
      log ERROR "FAIL_STATE_OS_CONTRADICTION: state=COMPLETED_NOBLE but OS=${ver}"
      die "$EC_STATE" "FAIL_STATE_OS_CONTRADICTION (state=COMPLETED_NOBLE os=${ver})"
      ;;
    *)
      local corrupt_dest
...
main() {
  ...
  CURRENT_HOP_ENV_FILE="${STATE_ROOT}/current-hop.env"
  META_RELEASE_FILE="/etc/update-manager/meta-release"
  KEYRING_PATH="/etc/apt/trusted.gpg.d/stellar-offline-jammy-to-noble.gpg"
  ...
  # Loading focal-to-jammy markers into b2f globals causes false CURRENT_HOP_MUTATION.
  handle_existing_state
  load_current_hop_identity_vars || true
  load_release_upgrade_started_flag_for_current_hop
  detect_partial_release_transition
